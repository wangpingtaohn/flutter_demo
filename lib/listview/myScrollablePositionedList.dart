...
class MyScrollablePositionedListPage extends StatefulWidget {
  const MyScrollablePositionedListPage({Key key}) : super(key: key);

  @override
  _MyScrollablePositionedListPageState createState() =>
      _MyScrollablePositionedListPageState();
}

class _MyScrollablePositionedListPageState
    extends State<MyScrollablePositionedListPage> {
    ...
    builder: (context, positions, child) {
      ...
      if (positions.isNotEmpty) {
        ...
        position.itemLeadingEdge > max.itemLeadingEdge
            ...
            : max)
            .index;
        print('min=' + min.toString() + ',max=' +max.toString());
      }
      return Row(
        children: <Widget>[
